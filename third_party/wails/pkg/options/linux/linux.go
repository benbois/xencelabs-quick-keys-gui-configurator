...
type Options struct {
	...
	// ApplicationID sets the Wayland application ID (e.g. "xencelabs-quick-keys").
	// On Wayland/GNOME, the window icon comes from the .desktop file associated with this ID,
	// not from gtk_window_set_icon. If empty, the Wayland app_id is not set.
